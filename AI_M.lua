...
dofile( "./AI_sakray/USER_AI/M_SkillList.lua" )
...
dofile( "./AI_sakray/USER_AI/M_Config.lua")
dofile( "./AI_sakray/USER_AI/M_Tactics.lua")
pcall(function () dofile( "./AI_sakray/USER_AI/Mob_ID.lua") end)
dofile( "./AI_sakray/USER_AI/AI_main.lua")
dofile( "./AI_sakray/USER_AI/M_PVP_Tact.lua")
dofile( "./AI_sakray/USER_AI/M_Extra.lua")
...
function WriteStartupLog(Version,ErrorCode,ErrorInfo)
	...
	TestFile=io.open("./AI_sakray/USER_AI/data/testM.txt","w") --different name since they'd be potentially running simulaneously if user logged in with homun and merc out
...
if CVersion==nil then
	...
	--]]
	if fsize("./AI_sakray/USER_AI/M_Config.lua")==3017 then
		ConfigVers="Default: "..LastSavedDate
	else
		ConfigVers="Custom, edited "..LastSavedDate
	end
	if fsize("./AI_sakray/USER_AI/M_Tactics.lua")==547 then
